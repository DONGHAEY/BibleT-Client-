...
import Calender from "../BibleTrain/Calender";
...
import {
  changeTrainProfileImgApi,
  getOtherTrainProfileApi,
} from "../../api/bibletrain";
...
const ProfileDetail = () => {
  ...
  const loadProfileData = async () => {
    try {
      setProfile(await getOtherTrainProfileApi(trainId, userId));
    } catch (e) {
      alert(e);
    }
  };
  ...
  const onChange = async (e) => {
    try {
      ...
      await changeTrainProfileImgApi(trainId, formData);
  ...
  return profile ? (
    ...
    <FlexWrapper>Loading...</FlexWrapper>
  );
};
