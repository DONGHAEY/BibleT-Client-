    ...
    <div style={{ width: "100%" }}>
      ...
      >
        {trainProfile && trainProfile.role !== "ROLE_CAPTAIN" ? (
          ...
          >
            <img style={{ width: "50px" }} src={"/png/bus-stop.png"}></img>
            <span>탈퇴하기</span>
          </div>
        ) : (
          <div
        ...
        >
          <img style={{ width: "50px" }} src={"/png/anal.png"}></img>
          <span>분석하기</span>
        </Link>
        <div
          style={{
          ...
          onClick={async () => {}}
        >
          <img style={{ width: "50px" }} src={"/png/종.png"}></img>
          <span>알림켜기</span>
        </div>
        <div
          style={{
          ...
          onClick={async () => {}}
        >
          <img style={{ width: "50px" }} src={"/png/info.png"}></img>
          <p>기차정보</p>
        </div>
      </div>
    </div>
