...
const ProfileDetail = () => {
    ...
    return (
        ...
        <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center'}}>
            <img style={{borderRadius:'100%', width:'150px', height:'150px'}} src={profile.profileImage}></img>
            <span style={{cursor :'pointer'}} onClick={() => setPopup({
                imgEdit:true
            })}><AiOutlineEdit /></span>
            ...
            {popup.imgEdit ? <Container>
                ...
                <img style={{maxWidth:'80px', maxHeight:'80px'}} src={profile.profileImage} />
                <input type='file'
